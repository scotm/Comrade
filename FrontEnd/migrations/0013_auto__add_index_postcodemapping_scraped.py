...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PostcodeMapping', fields ['scraped']
        db.create_index(u'FrontEnd_postcodemapping', ['scraped'])


    def backwards(self, orm):
        # Removing index on 'PostcodeMapping', fields ['scraped']
        db.delete_index(u'FrontEnd_postcodemapping', ['scraped'])
    ...
    models = {
        ...
        u'FrontEnd.postcodemapping': {
            ...
            'scraped': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'})
        },
        u'FrontEnd.region': {

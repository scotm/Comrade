...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AddressRecord.main_door'
        db.delete_column(u'FrontEnd_addressrecord', 'main_door')

        # Adding field 'AddressRecord.original_data'
        db.add_column(u'FrontEnd_addressrecord', 'original_data',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'AddressRecord.prefix'
        db.add_column(u'FrontEnd_addressrecord', 'prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'AddressRecord.main_door_number'
        db.add_column(u'FrontEnd_addressrecord', 'main_door_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AddressRecord.main_door'
        db.add_column(u'FrontEnd_addressrecord', 'main_door',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'AddressRecord.original_data'
        db.delete_column(u'FrontEnd_addressrecord', 'original_data')

        # Deleting field 'AddressRecord.prefix'
        db.delete_column(u'FrontEnd_addressrecord', 'prefix')

        # Deleting field 'AddressRecord.main_door_number'
        db.delete_column(u'FrontEnd_addressrecord', 'main_door_number')

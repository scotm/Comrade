...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'FrontEnd_region', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')())

    def backwards(self, orm):

        # Changing field 'Region.geom'
        db.alter_column(u'FrontEnd_region', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=27700))

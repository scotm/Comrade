...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.local_authority'
        db.add_column(u'FrontEnd_address', 'local_authority',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Address.council_ref'
        db.add_column(u'FrontEnd_address', 'council_ref',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Address.council_tax_band'
        db.add_column(u'FrontEnd_address', 'council_tax_band',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Address.local_authority'
        db.delete_column(u'FrontEnd_address', 'local_authority')

        # Deleting field 'Address.council_ref'
        db.delete_column(u'FrontEnd_address', 'council_ref')

        # Deleting field 'Address.council_tax_band'
        db.delete_column(u'FrontEnd_address', 'council_tax_band')
